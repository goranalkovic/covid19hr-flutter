...
import 'package:covid19hr/legend_item.dart';
import 'package:covid19hr/loading_screen.dart';
      ...
      children: [
        MouseRegion(
          ...
          onHover: (event) {
            ...
            final currentX = event.position.dx - 30;

            verticalLineX.value = currentX;

            final step = (maxX - minX) / data.length;

            currentIndex.value =
                (currentX / step).round().clamp(0, data.length - 1);
          },
          child: GestureDetector(
            onHorizontalDragUpdate: (event) {
              ...
              final currentX = event.globalPosition.dx - 30;
